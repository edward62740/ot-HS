...
#define LEDx_GPIO_CLK_ENABLE(__INDEX__)         __HAL_RCC_GPIOC_CLK_ENABLE() /* All Led on same port */
#define LEDx_GPIO_CLK_DISABLE(__INDEX__)        __HAL_RCC_GPIOC_CLK_DISABLE() /* All Led on same port */
/**
  * @}
  */ 
